...
export const COMPANY_INFO = {
  ...
  /** Applications go here rather than to the general inbox. */
  careersEmail: "hr@vdoit.in",
  phone: "+91-8800665460",
  address: "Gurugram, India",
  corporateLocation: "Gurugram, India",
  /**
  ...
  headline:
    "Pioneering Enterprise AI & Value-Oriented Digital Engineering Since 2015",
  subheadline:
    "Founded by tech veterans with extensive US leadership experience, VDO IT Technologies delivers mission-critical AI systems, autonomous agents, and enterprise cloud solutions designed to create measurable business growth.",
  ...
  stats: [
    {
      label: "Founded in",
      value: "2015",
      sub: "From two people to 100+ engineers",
    },
    {
      label: "Projects delivered",
      value: "200+",
      sub: "Government, enterprise and product",
    },
    {
      label: "Global clients",
      value: "100+",
      sub: "Served across India, US and UAE",
    },
    {
      label: "Certified to",
      value: "ISO 27001",
      sub: "And ISO 9001:2015. MSME registered",
    },
  ],
};
...
export const FOUNDERS: FounderProfile[] = [
  {
    ...
    bio: "With over 15 years of technology leadership across the United States and global digital ecosystems, Narinder founded VDO IT Technologies in 2015 with a singular conviction: delivering high-value, client-centric engineering without enterprise bloat. Over the past three years, he has led VDOIT’s strategic evolution into cutting-edge enterprise AI, large language model orchestration, and predictive business intelligence.",
    focusAreas: [
      "Enterprise AI Strategy",
      "Large-Scale System Architecture",
      "US & Global Client Success",
      "Generative AI Modernization",
    ],
    linkedinUrl: "https://www.linkedin.com/in/nkamra/",
    initials: "NK",
  },
  {
    name: "Neetu Gupta",
    ...
    linkedinUrl: "https://www.linkedin.com/in/neetugupta/",
    initials: "NG",
  },
];
...
export const SERVICES: ServiceItem[] = [
  {
    ...
    tagline:
      "Private, secure domain-adapted AI pipelines for enterprise intelligence.",
    description:
      "We design and deploy production-grade Retrieval-Augmented Generation (RAG) frameworks, fine-tuned proprietary models, and domain-specialized AI assistants that interact securely with your enterprise data without IP leakage.",
    features: [
    ...
    businessImpact:
      "Reduces manual document analysis time by up to 85% while guaranteeing 100% intellectual property containment.",
    iconName: "Sparkles",
    badge: "Core Focus",
  ...
  },
  {
    ...
    tagline:
      "Self-orchestrating intelligent agents that execute multi-step operations.",
    description:
      "Move beyond basic chatbots. We architect autonomous AI agents capable of reasoning, calling enterprise APIs, verifying intermediate outputs, and orchestrating complex cross-departmental operations with human-in-the-loop oversight.",
    features: [
    ...
    businessImpact:
      "Automates up to 60% of repetitive operational touchpoints, accelerating transaction cycle times 4x.",
    iconName: "Bot",
    badge: "High ROI",
  ...
  },
  {
    ...
    tagline:
      "Convert historical business data into forward-looking competitive advantage.",
    description:
      "Leveraging mathematically rigorous statistical algorithms and deep learning models, we build predictive engines that forecast market demand, anticipate supply chain disruptions, identify customer churn risks, and prevent fraud.",
    features: [
    ...
    businessImpact:
      "Lowers inventory carrying costs by 28% and mitigates high-value operational risk before it manifests.",
    iconName: "TrendingUp",
    badge: "Data-Driven",
  ...
  },
  {
    ...
    description:
      "From industrial defect detection on assembly lines to healthcare diagnostic imaging and retail foot-traffic analytics, our computer vision engineers deploy ultra-fast neural networks to edge hardware and cloud infrastructures.",
    features: [
    ...
    businessImpact:
      "Eliminates 99.4% of manufacturing escape defects while operating at sub-50ms inference latencies.",
    iconName: "ScanEye",
  ...
  },
  {
    ...
    tagline:
      "Scalable cloud foundations engineered for real-time AI workloads.",
    description:
      "AI is only as good as the underlying data architecture. We re-platform legacy monolithic architectures into cloud-native, microservices-driven ecosystems on AWS, GCP, and Azure with robust data lakehouses and streaming pipelines.",
    features: [
    ...
    businessImpact:
      "Cuts infrastructure overhead by 35% while establishing unified data readiness for real-time AI models.",
    iconName: "Database",
    badge: "Foundation",
  ...
  },
  {
    ...
    tagline:
      "Precision-engineered web, mobile, and SaaS platforms built to scale.",
    description:
      "Drawing from 10+ years of custom engineering excellence, we build resilient, high-traffic web applications, cross-platform mobile apps, and proprietary SaaS platforms that power day-to-day operations for global market leaders.",
    features: [
    ...
    businessImpact:
      "Accelerates time-to-market by 50% with clean, maintainable, enterprise-grade codebase ownership.",
    iconName: "Code2",
    badge: "Proven 10+ Yrs",
  },
];
...
export const INDUSTRIES: IndustryItem[] = [
  {
    ...
    tagline:
      "HIPAA-compliant AI diagnostic aids and patient lifecycle orchestration.",
    description:
      "Transforming clinical workflows with AI medical record summarization, automated diagnostic image triage, patient scheduling agents, and secure telehealth infrastructure.",
    aiUseCases: [
    ...
    keyOutcome:
      "99.2% accuracy in claims data extraction, reducing administrative workload by 70%.",
    iconName: "Activity",
    statNumber: "70%",
  ...
  },
  {
    ...
    description:
      "Empowering financial institutions with AI underwriting, instant AML/KYC verification, algorithmic credit assessment, and conversational banking interfaces.",
    aiUseCases: [
    ...
    keyOutcome:
      "$14M+ in mitigated fraudulent transactions across global client portfolios.",
  ...
  },
  {
    ...
    tagline:
      "Predictive routing, warehouse automation, and dynamic freight optimization.",
    description:
      "Eliminating dead miles and inventory bottlenecks through AI route optimization, computer vision parcel tracking, and dynamic demand forecasting.",
    aiUseCases: [
    ...
    keyOutcome:
      "32% decrease in fleet turnaround time and 22% fuel expenditure savings.",
    iconName: "Truck",
    statNumber: "32%",
  ...
  },
  {
    ...
    description:
      "Integrating industrial IoT sensor telemetry with edge computer vision to stop equipment breakdowns before they happen and automate quality control.",
    aiUseCases: [
    ...
    keyOutcome:
      "Reduced unscheduled plant downtime by 41% across high-precision facilities.",
    iconName: "Factory",
    statNumber: "41%",
  ...
  },
  {
    ...
    tagline:
      "Hyper-personalized customer journeys and intelligent inventory management.",
    description:
      "Driving conversion rates with AI recommendation engines, dynamic price adjustments, automated product cataloging, and intelligent conversational shopping.",
    aiUseCases: [
    ...
    keyOutcome:
      "27% uplift in average order value (AOV) and 35% higher search conversion.",
  ...
  },
  {
    ...
    tagline:
      "Intelligent building automation, valuation AI, and property management agents.",
    description:
      "Modernizing property ecosystems through automated lease contract intelligence, predictive energy management, and smart valuation models.",
    aiUseCases: [
    ...
    keyOutcome:
      "24% energy conservation and 80% faster lease verification cycles.",
    iconName: "Building2",
    statNumber: "24%",
...
export const LINKEDIN_POSTS: LinkedInPost[] = [
  // The post at the top of the LinkedIn feed, carried here in full rather than
  // summarised — the featured slot on /updates renders `fullContent` when it
  // is present, so the post reads on the site without a round trip.
  {
    id: "post-careers",
    ...
    fullContent:
      "Impact-Driven Work: Solve high-scale engineering challenges alongside a team of bright, forward-thinking peers.\n\nModern Stack: Work with state-of-the-art tools, cloud infrastructures, and modern frameworks.\n\nGrowth & Culture: High autonomy, rapid career progression, and a culture that values creative problem-solving.",
    tags: ["#Careers", "#ITJobs", "#VDOIT"],
    linkedinUrl:
      "https://www.linkedin.com/company/vdoitech/posts/?feedView=all",
  },
  {
    id: "post-assocham-real-estate",
    title: "Narinder Kamra at ASSOCHAM’s National Conference on Real Estate",
    date: "September 2026",
    category: "Announcement",
    excerpt:
      "Our Founder & CEO on the transformative role of AI and emerging technologies in real estate, at ASSOCHAM India’s National Conference on Real Estate.",
    fullContent:
      "Technology is the cornerstone of building a futuristic and resilient infrastructure for a #ViksitBharat.\n\nCatch our Founder & CEO, Narinder Kamra, sharing key insights at ASSOCHAM India’s National Conference on Real Estate, emphasizing the transformative role of AI and emerging technologies in the real estate domain.\n\nThank you ASSOCHAM India for hosting such an insightful conference!",
    tags: ["#AIinRealEstate", "#PropTech", "#UrbanDevelopment"],
    linkedinUrl:
      "https://www.linkedin.com/company/vdoitech/posts/?feedView=all",
  },
  {
    id: "post-ai-not-a-race",
    title: "AI Is Not a Race. It’s a Business Decision.",
    date: "September 2026",
    ...
    fullContent:
      "Everyone seems to be running behind AI today. New models. New platforms. New copilots. New agents. New automation.\n\nAnd in this race, businesses can easily start accumulating AI tools, subscriptions, infrastructure and integration costs — only to realize later that the AI investment has created more overhead than business value.\n\nThe reality is simple: there is no one-size-fits-all AI architecture.\n\nEvery business case has its own twist. The right AI components depend on multiple factors: your business objective, your legacy systems, your data maturity, AI model selection, integration complexity, security and compliance, scalability, total cost of ownership, and your ambition versus your budget.\n\nThis is where VDOIT Technologies brings a different perspective. We don’t start with: “Which AI technology should we implement?” We start with: “What are you trying to achieve, what do you already have, and what is the smartest way to get there?”\n\nOur experts assess your legacy technology landscape, data, business goals, AI readiness and budget before defining the right AI strategy and architecture. Because sometimes the smartest AI solution is not the biggest one. Sometimes it is about using less, integrating better, reusing what already works, and investing only where AI creates measurable value.\n\nYour AI ambition should be bold — but financially intelligent. Don’t just join the AI race. Choose the right race for your business.",
    tags: ["#EnterpriseAI", "#AIStrategy", "#AIArchitecture"],
    linkedinUrl:
      "https://www.linkedin.com/company/vdoitech/posts/?feedView=all",
  },
  {
  ...
  {
    id: "post-edtech-curriculum",
    title: "The old school curriculum is laggy. Time for a system update.",
    date: "June 2026",
    category: "Perspective",
    excerpt:
      "Traditional education moves at a snail’s pace while the tech landscape sprints ahead. Our answer is AI-first: predictive skill mapping and simulation-based qualification.",
    tags: ["#EdTech", "#FutureOfLearning", "#SkillGap"],
    linkedinUrl:
      "https://www.linkedin.com/company/vdoitech/posts/?feedView=all",
  },
  {
    id: "post-gcc-brain-trust",
    title:
      "India is not an outsourcing hub any more. It is the global brain trust.",
    date: "April 2026",
    category: "Perspective",
    excerpt:
      "Global Capability Centres in India have gone from cost-saving units to innovation engines. Standing one up is the heavy lifting — we run it as a single-window ecosystem.",
    tags: ["#GCCIndia", "#GlobalCapabilityCenters", "#BusinessExpansion"],
    linkedinUrl:
      "https://www.linkedin.com/company/vdoitech/posts/?feedView=all",
  },
  {
    id: "post-achievers-day",
    title: "Reflecting on achievement: more than just the milestone",
    date: "March 2026",
    category: "Life at VDOIT",
    excerpt:
      "The world celebrates the award and the finished project. Real achievement is built in the quiet, consistent, often difficult moments before the finish line.",
    fullContent:
      "As we mark International Achievers Day, at VDOIT, we want to pause and reflect on what “achievement” truly means.\n\nWhile the world often celebrates the final result — the award, the completed project, the revenue target hit — we know that real achievement is built in the quiet, consistent, and often challenging moments that precede the finish line.\n\nIt’s about resilience: the decision to keep going when things get difficult. Consistency: the everyday dedication that turns small steps into great distances. Learning: having the courage to face setbacks and use them as stepping stones.\n\nToday, we honor not just the victory, but the journey. We salute the discipline, the early mornings, the difficult decisions, and the unwavering commitment to progress.\n\nTo everyone striving, building, and persisting: we see you. Keep going.",
    tags: ["#InternationalAchieversDay", "#Achievement", "#Leadership"],
    linkedinUrl:
      "https://www.linkedin.com/company/vdoitech/posts/?feedView=all",
  },
  {
    id: "post-japan-offerings",
    title: "VDOIT offerings for Japan",
    date: "February 2026",
    category: "Announcement",
    excerpt:
      "Our capability brief for the Japanese market, published in Japanese: AI, ML and LLM engineering, Tableau, and a decade of delivery for clients across the US, Europe, the Gulf and Asia-Pacific.",
    tags: ["#Japan", "#EnterpriseAI"],
    linkedinUrl:
      "https://www.linkedin.com/company/vdoitech/posts/?feedView=all",
  },
  {
    id: "post-new-clients",
    title: "Welcoming our new strategic clients",
    date: "January 2026",
    category: "Announcement",
    excerpt: "We are proud to welcome our new strategic clients.",
    tags: ["#VDOITTechnologies", "#Tableau"],
    linkedinUrl:
      "https://www.linkedin.com/company/vdoitech/posts/?feedView=all",
  },
  {
    id: "post-cloud-smart",
    title: "Cloud success is not about moving fast. It is about moving smart.",
    date: "January 2026",
    category: "Perspective",
    excerpt:
      "Many organisations migrate expecting instant results. Value arrives when strategy, governance and continuous optimisation work together — the cloud rewards intentional decisions, not blind migration.",
    tags: ["#Cloud", "#Data", "#IT"],
    linkedinUrl:
      "https://www.linkedin.com/company/vdoitech/posts/?feedView=all",
  },
...
export const TIMELINE_MILESTONES = [
  ...
  },
  {
    ...
    description:
      "Scaled delivery footprint across the United States, Europe, and APAC. Delivered over 100+ mission-critical cloud platforms, SaaS systems, and enterprise data solutions.",
  },
  {
    year: "2021",
    title: "Strategic Pivot to Predictive AI & Machine Learning",
    description:
      "Invested in dedicated AI labs. Began deploying predictive maintenance, fraud detection, and automated computer vision solutions for Fortune 500 and high-growth mid-market clients.",
  },
  {
    year: "2023 - Present",
    title: "Frontier Enterprise Generative AI & Autonomous Agent Hub",
    description:
      "Deepened core focus into advanced Generative AI, RAG enterprise pipelines, autonomous multi-agent workflows, and private model governance for global market leaders.",
  },
];
...
export const ADVANTAGES = [
  {
    ...
    description:
      "Founded by senior leaders with direct Silicon Valley and US corporate delivery heritage, ensuring communication clarity, rigorous standards, and strategic alignment.",
    icon: "Award",
  },
  {
    title: "Established 2015 Track Record",
    description:
      "Unlike early-stage AI startups, we bring over a decade of continuous operational stability, mature SDLC frameworks, and 200+ verified enterprise deployments.",
    icon: "Building",
  },
  {
    title: 'Zero "Hype AI" — 100% Value & ROI',
    description:
      "We do not build novelty AI. Every architecture is mapped directly to key business metrics: cost reduction, throughput increase, or new revenue generation.",
    icon: "Target",
  },
  {
    title: "Strict IP Protection & Data Security",
    description:
      "Complete data isolation with private VPC deployments, enterprise encryption, role-based access control, and absolute code/data ownership for your company.",
    icon: "Lock",
  },
  {
    title: "End-to-End Execution Under One Roof",
    description:
      "From strategy and feasibility audits to data engineering, AI fine-tuning, UI/UX, and post-deployment MLOps, we handle the full lifecycle.",
    icon: "Layers",
  },
  {
    title: "Agile & High-Velocity Global Delivery",
    description:
      "Round-the-clock delivery cycles bridging US timezones with specialized AI engineering squads for rapid iteration and rapid time-to-value.",
    icon: "Zap",
  },
];
  ...
  perks: [
    {
      ...
      description:
        "No six-week onboarding theatre. You get repo access, a real ticket, and a reviewer on day one.",
      iconName: "Rocket",
    },
    {
      title: "Frontier AI, not demo AI",
      description:
        "RAG at enterprise scale, multi-agent orchestration, private model governance — deployed, monitored, and paid for.",
      iconName: "Cpu",
    },
    {
      title: "Remote-first, globally distributed",
      description:
        "US and India delivery hubs with async-first practice. Output is measured, hours are not.",
      iconName: "Globe2",
    },
    {
      title: "Learning budget that gets used",
      description:
        "Dedicated upskilling time each cycle for certifications, research papers, and internal AI labs.",
...
export const VISION_MISSION = {
  vision: {
    ...
    body: "Technology earns its place when it removes complexity rather than relocating it. We build systems that make large organisations easier to run — for the people inside them, and for the citizens and customers they serve.",
  },
  mission: {
    label: "Mission",
    statement: "Be the tech enabler, not the tech vendor.",
    body: "Deliver simple, high-quality solutions that accelerate business growth — through agile delivery, sustained investment in R&D, and engineering standards that hold up to ISO and government audit.",
  },
} as const;
...
export const CREDENTIALS: Credential[] = [
  { label: "ISO 9001:2015", detail: "Quality management systems, certified" },
  {
    ...
    detail: "Information security management, certified",
  },
...
export const OFFICES = [
  {
    ...
    city: "Gurugram",
    address:
      "912, Emaar Palm Square, Sector-66, Golf Course Ext Rd, Gurugram 122011",
  },
  // Removed from the site for now. This list feeds the footer, the About page,
  // the postal addresses and `areaServed` in the JSON-LD, and `llms.txt`, so
  // restoring an office here puts it back in all five.
  // {
  //   country: 'USA',
  //   city: 'Las Vegas',
...
export const FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "The company was founded in 2015 and is headquartered in Gurugram, India. Delivery runs across India and the United States on an on-site and off-shore model, so work can be staffed in either timezone.",
  },
  {
...
export const MANAGEMENT_TEAM: TeamMember[] = [
  ...
  },
  {
    ...
    initials: "AS",
    image: "/images/team/aman-sharma.webp",
    ...
    linkedinUrl: "https://www.linkedin.com/in/amanchd/",
  },
];
 ...
 */
export const ALL_ENGAGEMENTS: CaseStudy[] = [
  ...CASE_STUDIES,
  ...MORE_ENGAGEMENTS,
];
...
export const CLIENT_LOGOS: ClientLogo[] = [
  ...
  {
    name: "Awakening Health Lab",
    src: "/images/clients/awakening-health-lab.webp",
  },
  {
    name: "The NorthCap University",
    src: "/images/clients/northcap-university.webp",
  },
  ...
  {
    name: "Rolling Stones India",
    src: "/images/clients/rolling-stones-india.webp",
  },
...
/**
 * The AI capability ring on the home hero: the domains VDOIT builds in, and
 * what gets built in each.
 *
 * Kept separate from `INDUSTRIES`, which is a shorter list carrying outcome
 * stats and long-form copy for the industries band. This one is the map on the
 * figure — more nodes, fewer fields — and the two are allowed to overlap.
 *
 * Order is the order around the ring, clockwise from twelve o'clock.
 */
export const AI_APPLICATIONS: AiApplication[] = [
  ...
  },
  {
    ...
    iconName: "Landmark",
    useCases: [
      "Regtech KYC (face detection)",
      "Investment portfolio optimization",
      "ETF replication for index tracking",
      "Fraud detection",
      "Payments with face",
      "Trader oversight",
  ...
  },
  {
    ...
    label: "Autonomous",
    iconName: "Car",
    useCases: ["Autonomous cars", "Autonomous drones"],
  },
  {
    id: "insurance",
    name: "Insurance",
  ...
  },
  {
    ...
    iconName: "HeartPulse",
    useCases: [
      "Preventive care with wearables",
      "Medical imaging",
